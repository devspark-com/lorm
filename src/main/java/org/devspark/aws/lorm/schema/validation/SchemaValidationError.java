...
public class SchemaValidationError {
    ...
    public SchemaValidationError(AttributeDefinition attributeDefinition,
	    SchemaValidationErrorType errorType, SchemaValidationScope validationScope,
    ...
    public static SchemaValidationError buildRecursiveError(Class<?> entityClass,
	    Class<?> recursiveClass, String attributeName) {
	return new SchemaValidationError(null, SchemaValidationErrorType.GENERAL,
		SchemaValidationScope.ATTRIBUTE, attributeName,
		"Found recursive dependency path on entity " + entityClass.getName()
			+ ", with dependency type " + recursiveClass.getName());
    }
