...
public class DefaultItemToEntityMappingStrategy implements ItemToEntityMappingStrategy {

    private final ReflectionSupport reflectionSupport;

    public DefaultItemToEntityMappingStrategy(ReflectionSupport reflectionSupport) {
	super();
	...
	reflectionSupport.setValueOfField(field, entityInstance, itemEntry.getValue());
    }
}
