...
public class ReflectionSupportTest {
	...
	Field idField = refSupport.getFieldWithAnnotation(paramClass.getClass(), Id.class);
	...
	ReflectionSupport refSupport = new ReflectionSupport();
	Field idField = refSupport.getFieldWithAnnotation(instance.getClass(), Id.class);

	Assert.assertEquals("123456", refSupport.getValueOfField(idField, instance));
