...
public class EntityIdHandlerTest {
	...
	EntityIdHandler entityIdHandler = new EntityIdHandler(Merchant.class);

	Assert.assertEquals("Id", "123456", entityIdHandler.getIdValue(merchant));
    }
	...
	EntityIdHandler entityIdHandler = new EntityIdHandler(Merchant.class);
	entityIdHandler.setIdValue(merchant, entityIdHandler.generateId(merchant));
